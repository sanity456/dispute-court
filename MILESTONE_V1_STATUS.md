...
2. Local v4/v5 selection/rollback and isolated SQLite storage passed. Real Neon isolation, SQL transaction rollback and saved-hash recovery also passed using temporary schemas and simulated RPC failure; see [V5_RECOVERY_EVIDENCE.md](V5_RECOVERY_EVIDENCE.md). Actual deployed-preview release initialization, Vercel rollback and real retained/legacy credit recovery remain open. No transfer or migration of existing escrow.
