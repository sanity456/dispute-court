...
Updated 2026-09-24. **Separate v5 candidate deployed and source-verified. The public milestone branch has passing Ubuntu CI at immutable evidence commit `fe90fca1b83e07535f6db214c804c2d47f2fc386`. A deployment-specific v5 share link was tested without Vercel credentials: the page and a JavaScript asset both returned HTTP 200. Production remains on v4.**
